...
const BasePage = props => {
  ...
  const {
    ...
    className = '',
    header,
    title = "Portfolio - Nutdanai",
    metaDescription="My name is Nutdanai Kitphermjaroen and I am an experienced software engineer and freelance developer. Throughout my career, I have acquired advanced technical knowledge and the ability to explain programming topics clearly and in detail to a broad audience.",
    canonicalPath,
    children } = props;
